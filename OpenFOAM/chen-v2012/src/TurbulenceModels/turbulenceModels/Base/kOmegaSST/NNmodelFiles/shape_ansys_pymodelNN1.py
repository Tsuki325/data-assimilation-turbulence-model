...
# 创建图形和两个子图
fig, ax = plt.subplots()#fig, (ax_scatter, ax_bar) = plt.subplots(1, 2, figsize=(12, 6), gridspec_kw={'width_ratios': [3, 1]})
...
plt.show()
fig.savefig('NN1.png',format='png',dpi=600)
